...
On the easy MNIST dataset, we are able to quickly find a network that reaches > 98% accuracy. On the slightly more challenging CIFAR10 dataset, we get to X% after Y generations (with population 20).
